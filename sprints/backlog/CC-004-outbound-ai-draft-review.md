...
| LLM genereert ongepaste content (te formeel, te casual, taal-fout) → PM moet alles editen.                                                                             | Iteratie op prompt op basis van eerste 10 echte drafts. Houd `generation_error`-veld + `review_action='approved_edited'`-stats bij voor prompt-tuning.                                                                                                                                         |
