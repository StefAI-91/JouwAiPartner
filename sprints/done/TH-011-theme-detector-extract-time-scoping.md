...
| DATA-231 | ~~`themes.structured_content` toevoegen~~ — **uit scope van TH-011**. De column bestaat níét op `themes` (verwarring met `summaries.structured_content`, zie `packages/database/src/types/database.ts:1447`). Toevoegen heeft alleen zin wanneer de ThemeNarrator-sprint begint; hem nu opnemen is dead schema. Pas aan in die toekomstige sprint.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
