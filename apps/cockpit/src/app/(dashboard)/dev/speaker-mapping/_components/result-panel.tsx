import type { RunSpeakerMappingResult } from "@/actions/dev-speaker-mapping";
import { GroupedByPerson } from "./grouped-by-person";
import { Stat } from "./stat";

export function ResultPanel({ result }: { result: RunSpeakerMappingResult }) {
