...
/**
 * iMessage-stijl bubbles. Eigen-bericht (team) rechts in primary, ander-
 * bericht links in background. Date-dividers tussen dagen. Plain text
 * met `whitespace-pre-line` — geen markdown in v1.
 *
 * `currentProfileId` bepaalt welke kant elk bericht op staat. Een team-PM
 * ziet zijn eigen reply rechts; replies van collega-team-leden links.
 * Reden: bubbles tonen "ik" vs "anderen", niet team vs klant. Klant-replies
 * zitten ook links — zelfde mentale model als WhatsApp/iMessage.
 */
