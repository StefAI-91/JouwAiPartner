...
| `core.ts`        | Issue-rij + lijst- en count-queries                               | `IssueRow`, `IssueSort`, `ISSUE_SORTS`, `ISSUE_SELECT`, `StatusCountKey`, `StatusCounts`, `listIssues`, `countFilteredIssues`, `getIssueById`, `getIssueCounts`, `countCriticalUnassigned` |
