...
const STALE_TABLES = ["meetings", "extractions", "projects"] as const;
type StaleTable = (typeof STALE_TABLES)[number];

const STALE_ROW_COLUMNS: Record<StaleTable, string> = {
...
export async function getStaleRows(table: StaleTable, limit: number = 50): Promise<StaleRow[]> {
