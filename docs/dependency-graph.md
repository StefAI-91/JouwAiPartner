...
**Depends on:**
- (type) `@repo/database/queries/issues` → IssueRow
- `@repo/database/constants/issues` → ISSUE_STATUSES, ISSUE_STATUS_LABELS, ISSUE_PRIORITIES, ISSUE_PRIORITY_LABELS, ISSUE_TYPE_LABELS, type IssueType
