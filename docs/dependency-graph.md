...
> Auto-generated on 2026-04-10. Do not edit manually.
...
| ----------------------------------------- | ----- |
| Files scanned                             | 235   |
| Exported functions/constants              | 403   |
| Exported types/interfaces                 | 110   |
| Cross-package imports                     | 314   |
| Critical integration points (3+ packages) | 4     |
...
- `@repo/database/mutations/issues` → updateComment, deleteComment, insertActivity
- `@repo/database/validations/issues` → updateCommentSchema, deleteCommentSchema
- `@repo/auth/helpers` → getAuthenticatedUser
...
- `@repo/database/supabase/server` → createClient
- `@repo/database/supabase/admin` → getAdminClient
- `@repo/database/queries/issues` → getUserbackSyncCursor, getExistingUserbackIds, countUserbackIssues
- `@repo/database/mutations/issues` → upsertUserbackIssues
- `@repo/database/mutations/issues` → insertActivity
- `@repo/database/integrations/userback` → fetchAllUserbackFeedback, mapUserbackToIssue, extractMediaUrls, extractMediaFromMetadata
...
- `@repo/database/mutations/issues` → insertIssue, updateIssue, deleteIssue, insertComment, insertActivity
- `@repo/database/queries/issues` → getIssueById
- `@repo/database/constants/issues` → CLOSED_STATUSES, type IssueStatus
- `@repo/database/validations/issues` → createIssueSchema, updateIssueSchema, deleteIssueSchema, createCommentSchema
- `@repo/auth/helpers` → getAuthenticatedUser
...
- `@repo/database/supabase/server` → createClient
- `@repo/database/supabase/admin` → getAdminClient
- `@repo/database/queries/issues` → getUserbackSyncCursor, getExistingUserbackIds
- `@repo/database/mutations/issues` → upsertUserbackIssues
- `@repo/database/integrations/userback` → fetchAllUserbackFeedback, isTestSubmission, mapUserbackToIssue, extractMediaUrls
- `@repo/database/mutations/issue-attachments` → storeIssueMedia
...
| DevHub Server Actions  | 21       | 3   | 3    | -   | -   | 27    |
| DevHub API Routes      | 6        | -   | -    | -   | -   | 6     |
| DevHub Pages           | 15       | -   | -    | 6   | -   | 21    |
| MCP Server             | 23       | 1   | -    | -   | -   | 24    |
...
| Mutation            | Called from                                                                             |
| ------------------- | --------------------------------------------------------------------------------------- |
| `storeIssueMedia()` | `apps/devhub/src/actions/import.ts`, `apps/devhub/src/app/api/ingest/userback/route.ts` |
...
| `upsertUserbackIssues()` | `apps/devhub/src/actions/import.ts`, `apps/devhub/src/app/api/ingest/userback/route.ts`                                                                                                      |
| `deleteIssue()`          | `apps/devhub/src/actions/issues.ts`                                                                                                                                                          |
| `insertComment()`        | `apps/devhub/src/actions/issues.ts`                                                                                                                                                          |
| `updateComment()`        | `apps/devhub/src/actions/comments.ts`                                                                                                                                                        |
| `deleteComment()`        | `apps/devhub/src/actions/comments.ts`                                                                                                                                                        |
| `insertActivity()`       | `apps/devhub/src/actions/classify.ts`, `apps/devhub/src/actions/comments.ts`, `apps/devhub/src/actions/execute.ts`, `apps/devhub/src/actions/import.ts`, `apps/devhub/src/actions/issues.ts` |
...
| `getUserbackSyncCursor()`  | `apps/devhub/src/actions/import.ts`, `apps/devhub/src/app/api/ingest/userback/route.ts`                                                                            |
| `getExistingUserbackIds()` | `apps/devhub/src/actions/import.ts`, `apps/devhub/src/app/api/ingest/userback/route.ts`                                                                            |
