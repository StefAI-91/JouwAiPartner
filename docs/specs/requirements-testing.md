...
> **Bekende drift:** middel-hoog. Sprints T02-T07 + Q3a/Q3b hebben test-strategie en coverage-aanpak bijgewerkt. Canonieke bron voor test-strategie is nu `docs/specs/test-strategy.md` (Q3a output).
