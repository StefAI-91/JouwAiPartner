...
| Compositiepagina's (`components/[naam]/`) | `dashboard`, `weekly`, `intelligence`, `architectuur`, `administratie`, `agents`, `journey`                                                                                                       | `dashboard`                                                                                                | `briefing`, `meetings`, `roadmap`, `projects`, `feedback`, `inbox` |
